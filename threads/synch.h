...
class Puerto {
 public:
    // Constructor: inicializa el puerto para escuchar y recibir
    Puerto();	
  ...
  private:
	int buf; //buffer de puerto
	Lock *plock; // cerrojo 
	int pListen, pWriter;
	bool escbuffer,leerbuffer; 
	Condition *esperar_esc, *esperar_lec, *esc_buffer,*leer_buffer; // variable de condicion
 };
#endif // SYNCH_H
